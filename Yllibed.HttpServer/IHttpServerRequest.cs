...
public interface IHttpServerRequest
{
	...
	/// <param name="resultCode">The result code to send to the user-agent. Default is 200.</param>
	/// <param name="resultText">The result text to send to the user-agent. Default is "OK".</param>
	void SetResponse(
		string contentType,
	...
	/// </summary>
	/// <param name="contentType">The content-type of the response.</param>
	/// <param name="content">The content to send to the user-agent.</param>
	/// <param name="resultCode">The result code to send to the user-agent. Default is 200.</param>
	/// <param name="resultText">The result text to send to the user-agent. Default is "OK".</param>
	void SetResponse(
		string contentType,
